...
const ShopPage = () => {
  ...
  const [priceRange, setPriceRange] = useState([0, 1000]); // price range
  ...
  const handlePriceChange = (index, value) => { // handle change in selected price range 
    setPriceRange((prev) => {
      const newRange = [...prev];
...
// recommended: Use PascalCase for component folder names
